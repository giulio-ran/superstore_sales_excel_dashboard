<img width="2458" height="1116" alt="immagine" src="https://github.com/user-attachments/assets/eda4dead-bb28-4b17-abc6-968a39348bed" />
...
2. The center section shows the top-5 months, further zooming in on the previous graph.
3. The top-right section shows the revenue by quarter, again we can observe that the last quarter of the year, Q4, is the most profitable, with a gradual ascending trend throughout each year.
4. The center-right section shows the sales by sub-category (top-8 sub-categories). It shows that, among the most profitable sub-categories, Chairs and Phones are in the first place (14% of total sales each), followed by Storage (10%). A substantial portion is covered by Others, meaning all the sub-categories that generated lower revenue.
